...
@section('content')
    <div class="max-w-2xl mx-auto px-4 py-6">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <h3 class="text-2xl font-bold text-slate-800">Catat Surat Keluar</h3>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
            ...
            <form action="{{ route('surat-keluar.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    ...
                    <div class="w-full border border-slate-200 bg-slate-50 rounded-lg px-3 py-2 text-sm text-slate-500 italic">
