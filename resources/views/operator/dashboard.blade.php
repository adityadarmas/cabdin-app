...
@section('content')
    <div class="max-w-6xl mx-auto">
        <div class="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between"><div><p class="text-xs font-extrabold uppercase tracking-[.16em] text-blue-600">Dashboard Operator</p><h1 class="mt-2 text-2xl font-extrabold text-slate-800">Informasi Sekolah</h1><p class="mt-1 text-sm text-slate-500">Pantau pembaruan pengumpulan data dan pengumuman terbaru dari admin.</p></div><a href="{{ route('operator.pengajuan.index') }}" class="w-fit rounded-lg bg-blue-600 px-4 py-2.5 text-sm font-bold text-white hover:bg-blue-700">Buka Pengumpulan Data</a></div>
